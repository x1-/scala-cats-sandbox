...
[Scala With Cats](https://underscore.io/books/scala-with-cats/) を学ぶために作成したリポジトリです。 
...
Scala は ScalaにFunctionalプログラミングのための抽象概念を提供するライブラリです。
Catsという名前は `category` の短縮形から付けたそうです。

- [Cats | typelevel.org](https://typelevel.org/cats/)
...
Copyright x1-. Licensed [CC0 1.0][license].
